    ...
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{
                ...
                <h1 style={{ marginTop: 130, padding: 22, color: 'white' }}>İşyeri Taşımacılığı</h1>
                <p style={{ color: '#ffc107', paddingLeft: 22 }}>Anasayfa - İşyeri Taşımacılığı</p>
            </div>
            ...
            <div style={{ display: 'flex', width: '100%', height: 'calc(100vh - 300px)' }}>
                ...
                <div style={{ width: '75%', padding: '20px' }}>
                    ...
                    <h2 style={{ marginTop: '20px' }}>İşyeri Taşımacılığı</h2>
...
export default WorkplaceTransportation;